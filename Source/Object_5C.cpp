...
DEFINE_GLOBAL_INIT(Fix16, k_dword_6F8D38, Fix16(0x4000, 0), 0x6F8D38);
DEFINE_GLOBAL_INIT(Fix16, k_dword_6F8CE0, Fix16(0x4000, 0), 0x6F8CE0);
DEFINE_GLOBAL_INIT(Fix16, k_dword_6F8F74, Fix16(0x4000, 0), 0x6F8F74);
DEFINE_GLOBAL_INIT(Fix16, k_dword_6F8EE4, Fix16(0x2000, 0), 0x6F8EE4);

DEFINE_GLOBAL_INIT(Fix16, k_dword_6F8D3C, Fix16(0x2000, 0), 0x6F8D3C);
DEFINE_GLOBAL_INIT(Fix16, k_dword_6F8BE8, Fix16(0xFFFFC000, 0), 0x6F8BE8);

DEFINE_GLOBAL_INIT(Fix16, k_dword_6F8F2C, Fix16(0x2000, 0), 0x6F8F2C);
DEFINE_GLOBAL_INIT(Fix16, k_dword_6F8D24, Fix16(0x4000, 0), 0x6F8D24);
